package com.example.administrator.pallet;
...
import com.example.administrator.pallet.view.MyScrollView;
...
public class WelcompagerTransformer implements ViewPager.PageTransformer,ViewPager.OnPageChangeListener {
    ...
    public void transformPage(View view, float position) {
        Log.i("transposition123","position"+position+"id"+view.getTag()+"");
